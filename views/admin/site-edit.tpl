...
<form class="form-horizontal" action="{$SCRIPT_NAME}?action=submit" method="post">
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="style">User Menu Position</label>
			<div class="controls">
				...
				<span class="help-block">Where the menu should appear. Moving the menu to the top will require using a theme which widens the content panel. (e.g. nzbsu theme)</span>
			</div>
		</div>
