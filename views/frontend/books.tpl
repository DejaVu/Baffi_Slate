				...
				<div class="movextra" style="margin-top:10px">
					<table class="table">
						...
						<tr id="guid{$mguid[$m@index]}" {if $m@index > 1}class="mlextra"{/if}>
							...
							<td class="icons">
								<ul class="inline">
									<li><div class="icon icon_nzb"><a title="Download Nzb" href="{$smarty.const.WWW_TOP}/getnzb/{$mguid[$m@index]}/{$mname[$m@index]|escape:"url"}"><img src="{$smarty.const.WWW_TOP}/templates/baffi/images/icons/nzbup.png"></a></div></li>
									<li><a href="#" class="icon icon_cart" title="Add to Cart"><img src="{$smarty.const.WWW_TOP}/templates/baffi/images/icons/cartup.png"></a></li>
									<li>{if $sabintegrated}<a href="#" class="icon icon_sab" title="Send to my Sabnzbd"><img src="{$smarty.const.WWW_TOP}/templates/baffi/images/icons/sabup.png"></a>{/if}</li>
								</ul>
