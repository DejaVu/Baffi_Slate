    ...
    if (what != undefined)
    {
        $.ajax({
          ...
          success   : function(data)
          {
              ...
              if (what == 0) {
                  $('td#group-' + id).html('<a href="javascript:ajax_group_status('+ id +', 1)" class="group_active btn btn-mini btn-success">Activate</a>');
              }
              else {
                  $('td#group-' + id).html('<a href="javascript:ajax_group_status('+ id +', 0)" class="group_active btn btn-mini btn-danger">Deactivate</a>');
              }
